...
// separate context item by the host compaction hook, keeping the capsule bounded. Fixed template
...
function sanitizeBootstrapError(error) {
  ...
  return `${BOOTSTRAP_ERROR_PREFIX} ${reason}. Do not improvise a GSD workflow; continue with the host's ordinary behavior.`;
}
