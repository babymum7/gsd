...
// parallel sub-agents because their green evidence would race. Single-task
// waves are the ordinary inline path; `parallel` is true only for waves the
// session owner may fan out.
