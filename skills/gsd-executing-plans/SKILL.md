...
6. Run the canon's independent read-only review of the merged diff for every wave of two or more reconciled tasks; a finding blocks only by citing bound plan text or a red deterministic check.
