...
|---|---|---|---|---|
| Route 5 architecture audit | — | `docs/domain.toon` | — | — |
| Post-diagnosis architecture audit | — | `docs/domain.toon` | — | — |
