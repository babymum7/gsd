...
- **Don't reopen settled design.** ADRs and `CONTEXT.md` decisions are not refactor targets; a genuine structural rethink is a `gsd-improve-codebase-architecture` candidate, not a step in this loop.
