...
Print a compact feature/AC/task summary and the source binding. Ask one approval question: approve and execute, revise in Discussion, or review visually when the existing Lavish opt-in gate holds. This is the last normal prompt: approval immediately starts the post-approval pipeline; no later planning menu, confirmation, or visual-review offer appears, except the sole terminal scratch disposition (delete, retain, or archive-and-delete) offered after implementation checks pass and before final terminal review/squash; that disposition never reopens planning, visual review, or any other menu.
