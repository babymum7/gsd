...
Triage the prompt before any route: answer (read-only, or a Nano edit: one literal edit needing no test), clarify (ask exactly one question carrying a recommended default), research (gather the named codebase, documentation, or reference facts before answering, never from memory), quick, plan, or milestone; name one recommended option and its cost for every choice.
